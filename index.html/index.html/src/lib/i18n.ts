...
const en = {
  ...
  "register.shopCode": "Team join code",
  "register.shopCodePh": "Team join code",
  "register.shopCodeHint": "Employees use this — not the customer find code.",
  ...
  "share.rotateShop":
    "This only changes the customer find code. The team join code on Account stays the same. Old printed QRs stop working.",
  "share.rotateIndy": "Old printed QRs stop working after you generate a new code.",
  "share.pickCode": "Choose your own find code",
  ...
  "share.teamJoin": "Team join code",
  "share.teamJoinHint":
    "Employees type this when they create an account and join the shop. Customers never use this code.",
  ...
  "job.panHint": "Drag to look around",
  "job.resetView": "Reset view",
  "job.posting": "Posting…",
  "job.system": "System",
  "job.decline": "Decline booking",
  "job.declineHint": "Frees this time slot and the hours blocked after it, then notifies the customer.",
  ...
  "account.techShopHint": "Public shop profile, hours, job length, find code, and team are managed by the owner.",
  ...
  "account.findCode": "Customer find code",
  "account.findCodeHint": "Customers type this or scan the QR on Share. Not the team join code.",
  ...
  "account.add": "Add",
  "account.customersUseCode": "Customers use the find code (or the QR on Share) — not this team join code.",
  ...
  "err.findEqualsJoin": "The customer find code and team join code must be different.",
  "err.usedFindAsJoin": "That's the customer find code. Ask the owner for the team join code.",
  ...
  "book.bayFull": "This bay is full for the next four weeks. Check back later.",
  "book.takenHint": "A booking also blocks later slots on this bay for the job length the shop set.",
  "book.blocked": "Blocked",
  "book.calendarAria": "Available days and times",
  "book.prevMonth": "Previous month",
  "book.nextMonth": "Next month",
  "book.pickDay": "Pick a day",
  "book.pickTime": "Pick a time",
  "book.noSlotsDay": "No open times this day.",
  "book.dayOpen": "Times available",
  "book.dayFull": "All booked",
  "book.dayClosed": "Closed",
  "book.today": "Today",
  ...
  "account.jobLength": "Job length / block after booking",
  "account.jobLengthHint":
    "A booked start time also blocks later open slots on this bay for that many hours. Shop technicians use this owner setting. Default is 3 hours so a solo shop does not overbook.",
  "account.blockOff": "Off (same start only)",
  "account.block1h": "1 hour",
  "account.block2h": "2 hours",
  "account.block3h": "3 hours",
  "account.block4h": "4 hours",
...
const es: Record<MessageKey, string> = {
  ...
  "register.shopNamePh": "Riverside Auto",
  "register.shopCode": "Código de equipo",
  "register.shopCodePh": "Código de equipo",
  "register.shopCodeHint": "Lo usan los empleados — no es el código para clientes.",
  ...
  "register.findCode": "Tu código para clientes (opcional)",
  ...
  "share.rotateShop":
    "Esto solo cambia el código para clientes. El código de equipo en Cuenta se queda igual. Los QR impresos dejan de funcionar.",
  "share.rotateIndy": "Los QR impresos dejan de funcionar cuando generas un código nuevo.",
  "share.pickCode": "Elige tu código para clientes",
  ...
  "share.teamJoin": "Código de equipo",
  "share.teamJoinHint":
    "Los empleados lo escriben al crear su cuenta y unirse al taller. Los clientes nunca usan este código.",
  ...
  "job.zoomIn": "Acercar",
  "job.zoomOut": "Alejar",
  "job.panHint": "Arrastra para ver alrededor",
  "job.resetView": "Restablecer vista",
  "job.posting": "Publicando…",
  "job.system": "Sistema",
  "job.decline": "Rechazar cita",
  "job.declineHint": "Libera este horario y las horas bloqueadas después, y avisa al cliente.",
  ...
  "account.techShopHint": "El perfil público, el horario, la duración del trabajo, el código de clientes y el equipo los gestiona el dueño.",
  ...
  "account.findCode": "Código para clientes",
  "account.findCodeHint": "Los clientes lo escriben o escanean el QR en Compartir. No es el código de equipo.",
  ...
  "account.add": "Agregar",
  "account.customersUseCode": "Los clientes usan el código para clientes (o el QR en Compartir) — no este código de equipo.",
  ...
  "err.findEqualsJoin": "El código para clientes y el código de equipo deben ser distintos.",
  "err.usedFindAsJoin": "Ese es el código para clientes. Pide al dueño el código de equipo.",
  ...
  "book.bayFull": "Este espacio está lleno las próximas cuatro semanas. Vuelve más tarde.",
  "book.takenHint": "Una reserva también bloquea horarios siguientes en esta bahía por la duración que el taller definió.",
  "book.blocked": "Bloqueado",
  "book.calendarAria": "Días y horarios disponibles",
  "book.prevMonth": "Mes anterior",
  "book.nextMonth": "Mes siguiente",
  "book.pickDay": "Elige un día",
  "book.pickTime": "Elige un horario",
  "book.noSlotsDay": "No hay horarios libres este día.",
  "book.dayOpen": "Hay horarios",
  "book.dayFull": "Todo ocupado",
  "book.dayClosed": "Cerrado",
  "book.today": "Hoy",
  "book.notifySms":
  ...
  "account.jobLength": "Duración del trabajo / bloquear después de reservar",
  "account.jobLengthHint":
    "Una hora de inicio reservada también bloquea los siguientes horarios libres de esta bahía por esas horas. Los técnicos usan el ajuste del dueño. El valor predeterminado es 3 horas para que un taller solo no se sobrecargue.",
  "account.blockOff": "Apagado (solo la misma hora)",
  "account.block1h": "1 hora",
  "account.block2h": "2 horas",
  "account.block3h": "3 horas",
  "account.block4h": "4 horas",
...
const STORE_ERROR_KEYS: Record<string, MessageKey> = {
  ...
  "The customer find code and team join code must be different.": "err.findEqualsJoin",
  "That's the customer find code. Ask the owner for the team join code.": "err.usedFindAsJoin",
};
