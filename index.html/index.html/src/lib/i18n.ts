...
const en = {
  ...
  "shop.invoicesEmpty": "No invoices yet. Create one on a ticket.",
  ...
  "qr.sendShop": "Send this shop to a friend",
  "qr.saveQr": "Save QR",
  "qr.share": "Share",
  ...
  "book.moreDetails": "Email, trim, color, photos (optional)",
  "book.hideDetails": "Hide extra details",

  "vehicle.title": "Vehicle on the ticket",
  "vehicle.sub": "Year, make, model, then trim if you know it",
  "vehicle.subShort": "Year, make, and model",
  ...
  "photo.dropHint": "Drop a photo here, or choose / take one.",
  "photo.editAria": "Change profile photo",
  "photo.editPublicHint": "Customers see this on your page.",
  "photo.editAccountHint": "This is your account photo.",
  "photo.profileLabel": "Profile photo (optional)",
  "photo.shopLabel": "Shop logo or profile photo (optional)",
  "photo.profileHint": "This is your account photo.",
  "photo.shopHint": "Customers see this on your page.",
  "photo.indyHint": "Customers see this on your page.",
  ...
  "toast.alertsUnsupported": "This browser can't show alerts. Use Chrome or Safari, or the phone app.",
  ...
  "account.alertsCustomer":
    "Turn on alerts in this browser or the phone app. Text messages are not connected yet — until they are, the shop can call or text the number on the ticket.",
  "account.alertsProvider":
    "When you move a job to on the way, parts, or ready, the customer can get an alert on this device if they allowed it. Text messages are not sending yet — tap Text on the ticket to message them from this phone.",
  ...
  "job.callCustomerHint":
    "App texts are not sending yet. Call or text them from this phone with the number on the ticket.",
  "job.smsBodyEnroute": "{shop} is on the way.",
  "job.smsBodyParts": "{shop}: waiting on parts for your car.",
  "job.smsBodyReady": "{shop}: your car is ready.",
  "job.smsBodyUpdate": "{shop}: update on your appointment.",
  "job.writeEstimate": "Write estimate",
  "job.sendNewEstimate": "Send new estimate",
  "job.addParts": "Add parts ETA",
  "job.editParts": "Update parts",
  "job.confirmContinue": "Continue",
  "job.confirmStay": "Not yet",
  "job.hideForm": "Hide",
  ...
  "account.notifTitle": "Alerts on this device",
  "account.notifEnable": "Turn on notifications",
  "account.notifOn": "Notifications on",
  "account.notifTest": "Send test",
  "account.notifBlocked":
    "Alerts are blocked. Allow them for this site in the browser, or in Settings for the phone app.",
  "account.notifUnsupported": "This browser can't show alerts. Use Chrome or Safari, or the phone app.",
  ...
  "job.invoice": "Invoice",
  "job.invoiceHint": "Write the bill for this job, then share it.",
  ...
  "job.invoiceCustomerHint": "This is your bill from the shop.",
...
const es: Record<MessageKey, string> = {
  ...
  "qr.sendShop": "Envía este taller a un amigo",
  ...
  "book.moreDetails": "Correo, trim, color, fotos (opcional)",
  "book.hideDetails": "Ocultar extras",

  "vehicle.title": "Vehículo en el ticket",
  "vehicle.sub": "Año, marca, modelo y el trim si lo sabes",
  "vehicle.subShort": "Año, marca y modelo",
  ...
  "photo.dropHint": "Suelta una foto aquí, o elige / toma una.",
  "photo.editAria": "Cambiar foto de perfil",
  "photo.editPublicHint": "Los clientes la ven en tu página.",
  "photo.editAccountHint": "Esta es la foto de tu cuenta.",
  "photo.profileLabel": "Foto de perfil (opcional)",
  "photo.shopLabel": "Logo o foto de perfil del taller (opcional)",
  "photo.profileHint": "Esta es la foto de tu cuenta.",
  "photo.shopHint": "Los clientes la ven en tu página.",
  "photo.indyHint": "Los clientes la ven en tu página.",
  ...
  "toast.alertsUnsupported": "Este navegador no puede mostrar alertas. Usa Chrome o Safari, o la app del teléfono.",
  ...
  "account.alertsCustomer":
    "Activa las alertas en este navegador o en la app del teléfono. Los mensajes de texto aún no están conectados — hasta entonces el taller puede llamar o enviar un SMS al número del ticket.",
  "account.alertsProvider":
    "Cuando mueves un trabajo a en camino, piezas o listo, el cliente puede recibir una alerta en este dispositivo si la permitió. Los mensajes de texto aún no se envían — toca Texto en el ticket para escribirles desde este teléfono.",
  ...
  "job.callCustomerHint":
    "Los textos de la app aún no se envían. Llama o escríbeles desde este teléfono con el número del ticket.",
  "job.smsBodyEnroute": "{shop} va en camino.",
  "job.smsBodyParts": "{shop}: esperando piezas para tu auto.",
  "job.smsBodyReady": "{shop}: tu auto está listo.",
  "job.smsBodyUpdate": "{shop}: actualización de tu cita.",
  "job.writeEstimate": "Escribir presupuesto",
  "job.sendNewEstimate": "Enviar nuevo presupuesto",
  "job.addParts": "Agregar ETA de piezas",
  "job.editParts": "Actualizar piezas",
  "job.confirmContinue": "Continuar",
  "job.confirmStay": "Todavía no",
  "job.hideForm": "Ocultar",
  ...
  "account.notifTitle": "Alertas en este dispositivo",
  "account.notifEnable": "Activar notificaciones",
  "account.notifOn": "Notificaciones activadas",
  "account.notifTest": "Enviar prueba",
  "account.notifBlocked":
    "Las alertas están bloqueadas. Permítelas para este sitio en el navegador, o en Ajustes para la app del teléfono.",
  "account.notifUnsupported": "Este navegador no puede mostrar alertas. Usa Chrome o Safari, o la app del teléfono.",
  ...
  "job.partsEtaLine": " · ETA {eta}",
  "job.invoice": "Factura",
  "job.invoiceHint": "Escribe la cuenta de este trabajo y compártela.",
  ...
  "job.invoiceCustomerHint": "Esta es tu cuenta del taller.",
