...
const en = {
  ...
  "privacy.store.body":
    "A shop or independent can store a business name, find code, bio, specialties, credentials, service area, hours, support email or phone, and a profile photo or shop logo. Customers book jobs with that shop. Job tickets store the vehicle year, make, and model, optional symptoms and a symptom photo, the time slot, job status, parts notes, an invoice (line items, optional tax, total, paid or unpaid), and notes the shop writes.",
