...
const en = {
  ...
  "status.canceled.customer": "You canceled this appointment",
  ...
  "book.notifySms":
    "Notify me in the app when they are on the way, waiting on parts, or the car is ready. Text messages are not connected yet.",
  "book.symptomPhoto": "Photo of the problem (optional)",
  "book.symptomPhotoHint": "A leak, warning light, worn pad, or the noise source. The shop sees this on the ticket.",
  ...
  "account.alertsCustomer":
    "Turn on app alerts for the Play/App Store build. Text messages are not connected yet — we will use the phone on the ticket once SMS is live.",
  "account.alertsProvider":
    "When you move a job to on the way, parts, or ready, the customer can get an app alert if they allowed it. Text messages need Twilio on Railway and are not sending yet.",
  ...
  "privacy.not.body":
    "We do not sell your list to advertisers. We do not use Helper to train a public model on your name. Card numbers are not stored in this app today. Text messages for on-the-way, parts, and ready are not connected yet. App alerts use those same moments after you allow notifications.",
  ...
  "job.manageTitle": "Manage appointment",
  ...
  "job.addToCalendar": "Add to calendar",
  "job.googleCalendar": "Google Calendar",
  "job.appleCalendar": "Apple / Outlook (.ics)",
  "job.symptomPhoto": "Photo of the problem",
  "job.symptomPhotoHint": "What the customer sent when they booked.",
  "job.noSymptomPhoto": "No symptom photo on this ticket.",
  "job.estimate": "Written estimate",
  "job.estimateHint": "Dollar amount the customer can approve before In repair.",
  "job.estimateAmount": "Amount",
  "job.estimateNote": "What's included",
  "job.estimateNotePh": "Pads, rotors, labor",
  "job.estimateSend": "Send estimate",
  "job.estimateWaiting": "Waiting for the customer to approve.",
  "job.estimateApproved": "Customer approved {amount}",
  "job.estimateDeclined": "Customer declined {amount}",
  "job.estimateSkipped": "No written estimate — shop went ahead.",
  "job.estimateApprove": "Approve estimate",
  "job.estimateDecline": "Decline",
  "job.estimateCustomerHint": "This is what the shop quoted before they start the repair.",
  "job.repairNoEstimateConfirm":
    "No written estimate on this ticket. Continue into In repair without one? The customer will see that on the ticket.",
  "job.statusSkipConfirm": "Skip ahead to {to}? Intermediate steps will be skipped.",
  "job.undoStatus": "Undo last status",
  "job.parts": "Parts",
  "job.partsHint": "ETA the customer can see while you wait on parts.",
  "job.partsEta": "ETA",
  "job.partsEtaPh": "Friday afternoon",
  "job.partsNote": "Which parts",
  "job.partsNotePh": "Dealer rotor, OEM pads",
  ...
  "job.flagOwner": "Flag for owner",
  "job.unflagOwner": "Clear owner flag",
  "job.flagged": "Flagged for owner",
  "toast.estimateSent": "Estimate sent to the customer",
  "toast.estimateApproved": "Estimate approved",
  ...
  "toast.symptomPhotoSaved": "Photo attached to the booking",
  "note.estimateApproved": "Customer approved the estimate.",
  "note.estimateDeclined": "Customer declined the estimate.",
...
const es: Record<MessageKey, string> = {
  ...
  "status.canceled.customer": "Cancelaste esta cita",
  ...
  "book.notifySms":
    "Avísame en la app cuando vayan en camino, esperen piezas o el auto esté listo. Los mensajes de texto aún no están conectados.",
  "book.symptomPhoto": "Foto del problema (opcional)",
  "book.symptomPhotoHint": "Una fuga, luz de alerta, pastilla gastada o de dónde sale el ruido. El taller la ve en el ticket.",
  ...
  "account.alertsCustomer":
    "Activa las alertas de la app en la versión de Play/App Store. Los mensajes de texto aún no están conectados — usaremos el teléfono del ticket cuando el SMS esté en vivo.",
  "account.alertsProvider":
    "Cuando mueves un trabajo a en camino, piezas o listo, el cliente puede recibir una alerta de la app si la permitió. Los mensajes de texto necesitan Twilio en Railway y aún no se envían.",
  ...
  "privacy.photos.body":
    "La foto de perfil o el logo del taller viven en la cuenta y en la página pública. Una foto de la bahía (el auto o una pieza en un trabajo) se queda en ese ticket. El cliente puede adjuntar una foto del problema al reservar; se queda en ese ticket, aparte de la foto de la bahía. Una foto de la bahía no reemplaza tu foto de perfil.",
  ...
  "privacy.not.body":
    "No vendemos tu lista a anunciantes. No usamos Helper para entrenar un modelo público con tu nombre. Hoy esta app no guarda números de tarjeta. Los mensajes de texto para en camino, piezas y listo aún no están conectados. Las alertas de la app usan esos mismos momentos cuando las permites.",
  ...
  "job.manageTitle": "Administrar cita",
  ...
  "job.appointment": "Cita",
  "job.addToCalendar": "Agregar al calendario",
  "job.googleCalendar": "Google Calendar",
  "job.appleCalendar": "Apple / Outlook (.ics)",
  "job.symptomPhoto": "Foto del problema",
  "job.symptomPhotoHint": "Lo que el cliente envió al reservar.",
  "job.noSymptomPhoto": "No hay foto del problema en este ticket.",
  "job.estimate": "Presupuesto escrito",
  "job.estimateHint": "Monto que el cliente puede aprobar antes de En reparación.",
  "job.estimateAmount": "Monto",
  "job.estimateNote": "Qué incluye",
  "job.estimateNotePh": "Pastillas, discos, mano de obra",
  "job.estimateSend": "Enviar presupuesto",
  "job.estimateWaiting": "Esperando que el cliente apruebe.",
  "job.estimateApproved": "El cliente aprobó {amount}",
  "job.estimateDeclined": "El cliente rechazó {amount}",
  "job.estimateSkipped": "Sin presupuesto escrito — el taller siguió adelante.",
  "job.estimateApprove": "Aprobar presupuesto",
  "job.estimateDecline": "Rechazar",
  "job.estimateCustomerHint": "Esto es lo que cotizó el taller antes de empezar la reparación.",
  "job.repairNoEstimateConfirm":
    "No hay presupuesto escrito en este ticket. ¿Seguir a En reparación sin uno? El cliente lo verá en el ticket.",
  "job.statusSkipConfirm": "¿Saltar a {to}? Se omitirán los pasos intermedios.",
  "job.undoStatus": "Deshacer último estado",
  "job.parts": "Piezas",
  "job.partsHint": "ETA que el cliente ve mientras esperas las piezas.",
  "job.partsEta": "ETA",
  "job.partsEtaPh": "Viernes por la tarde",
  "job.partsNote": "Cuáles piezas",
  "job.partsNotePh": "Disco de agencia, pastillas OEM",
  ...
  "job.flagOwner": "Marcar para el dueño",
  "job.unflagOwner": "Quitar marca del dueño",
  "job.flagged": "Marcado para el dueño",
  "toast.estimateSent": "Presupuesto enviado al cliente",
  "toast.estimateApproved": "Presupuesto aprobado",
  ...
  "toast.symptomPhotoSaved": "Foto agregada a la cita",
  "note.estimateApproved": "El cliente aprobó el presupuesto.",
  "note.estimateDeclined": "El cliente rechazó el presupuesto.",
...
const STORE_ERROR_KEYS: Record<string, MessageKey> = {
  ...
  "Send a written estimate or confirm you are going in without one.": "err.repairNeedsEstimate",
...
const NOTE_KEYS: Record<string, MessageKey> = {
  ...
  "Customer approved the estimate.": "note.estimateApproved",
  "Customer declined the estimate.": "note.estimateDeclined",
  "Work started without a written estimate.": "note.estimateSkipped",
  "Flagged for the shop owner.": "note.flagged",
  "Owner flag cleared.": "note.unflagged",
};
