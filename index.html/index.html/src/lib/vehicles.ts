export const VEHICLE_DATA: Record<string, string[]> = {
  ...
  BMW: ["1 Series", "2 Series", "2 Series Gran Coupe", "3 Series", "3 Series Gran Turismo", "4 Series", "4 Series Gran Coupe", "5 Series", "5 Series Gran Turismo", "6 Series", "6 Series Gran Coupe", "7 Series", "8 Series", "i3", "i4", "i5", "i7", "i8", "iX", "iX3", "M2", "M3", "M4", "M5", "M6", "M8", "X1", "X2", "X3", "X3 M", "X4", "X4 M", "X5", "X5 M", "X6", "X6 M", "X7", "XM", "Z3", "Z4", "Z8", "Other"],
  ...
  Chevrolet: ["Astro", "Avalanche", "Aveo", "Beretta", "Blazer", "Blazer EV", "Bolt EUV", "Bolt EV", "Camaro", "Caprice", "Captiva", "Cavalier", "Celebrity", "Chevy Van", "City Express", "Classic", "Cobalt", "Colorado", "Corsica", "Corvette", "Cruze", "El Camino", "Equinox", "Equinox EV", "Express", "HHR", "Impala", "Lumina", "Malibu", "Malibu Maxx", "Monte Carlo", "Prizm", "S-10", "Silverado 1500", "Silverado 2500HD", "Silverado 3500HD", "Silverado EV", "Sonic", "Spark", "SS", "SSR", "Suburban", "Tahoe", "Tracker", "Trailblazer", "Traverse", "Trax", "Uplander", "Venture", "Volt", "Other"],
  ...
  GMC: ["Acadia", "Canyon", "Envoy", "Envoy XL", "Hummer EV", "Jimmy", "Safari", "Savana", "Sierra 1500", "Sierra 2500HD", "Sierra 3500HD", "Sierra EV", "Sonoma", "Terrain", "Yukon", "Yukon Denali", "Yukon XL", "Other"],
  Honda: ["Accord", "Accord Coupe", "Accord Hybrid", "Civic", "Civic Coupe", "Civic Hatchback", "Civic Hybrid", "Civic Si", "Civic Type R", "Clarity", "CR-V", "CR-V Hybrid", "CR-Z", "Crosstour", "del Sol", "Element", "Fit", "HR-V", "Insight", "Odyssey", "Passport", "Pilot", "Prelude", "Prologue", "Ridgeline", "S2000", "Other"],
  Hummer: ["H1", "H2", "H3", "H3T", "Other"],
  Hyundai: ["Accent", "Azera", "Elantra", "Elantra GT", "Elantra Hybrid", "Elantra N", "Entourage", "Equus", "Genesis", "Genesis Coupe", "Ioniq", "Ioniq 5", "Ioniq 5 N", "Ioniq 6", "Ioniq 9", "Kona", "Kona Electric", "Kona N", "Palisade", "Santa Cruz", "Santa Fe", "Santa Fe Hybrid", "Sonata", "Sonata Hybrid", "Tiburon", "Tucson", "Tucson Hybrid", "Veloster", "Veloster N", "Venue", "Veracruz", "XG300", "XG350", "Other"],
  ...
  "Mercedes-Benz": ["190E", "A-Class", "AMG GT", "B-Class", "C-Class", "C63 AMG", "CL-Class", "CLA", "CLK", "CLS", "E-Class", "E63 AMG", "EQB", "EQE", "EQE SUV", "EQS", "EQS SUV", "G-Class", "GL-Class", "GLA", "GLB", "GLC", "GLC Coupe", "GLE", "GLE Coupe", "GLK", "GLS", "M-Class", "Maybach S-Class", "Metris", "S-Class", "SL", "SLC", "SLK", "SLR", "SLS", "Sprinter", "Other"],
  ...
  Nissan: ["200SX", "240SX", "350Z", "370Z", "Altima", "Armada", "cube", "Frontier", "GT-R", "Juke", "Kicks", "Leaf", "Maxima", "Murano", "NV", "NV200", "Pathfinder", "Quest", "Rogue", "Rogue Select", "Rogue Sport", "Sentra", "Titan", "Titan XD", "Versa", "Versa Note", "Xterra", "Z", "Other"],
  ...
  Toyota: ["4Runner", "86", "Avalon", "Avalon Hybrid", "bZ4X", "C-HR", "Camry", "Camry Hybrid", "Camry Solara", "Celica", "Corolla", "Corolla Cross", "Corolla Hatchback", "Corolla Hybrid", "Crown", "Crown Signia", "Echo", "FJ Cruiser", "GR86", "GR Corolla", "GR Supra", "Grand Highlander", "Highlander", "Highlander Hybrid", "Land Cruiser", "Matrix", "Mirai", "MR2", "Paseo", "Prius", "Prius C", "Prius Plug-in", "Prius Prime", "Prius V", "RAV4", "RAV4 Hybrid", "RAV4 Prime", "Sequoia", "Sienna", "Sienna Hybrid", "Solara", "Supra", "Tacoma", "Tercel", "Tundra", "Tundra Hybrid", "Venza", "Yaris", "Yaris iA", "Other"],
